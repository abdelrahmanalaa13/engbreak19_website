...
(function() {
    ...
    GameOverPanel.prototype = {
        ...
        draw: function() {
            ...
            if(IS_MOBILE)
                var centerX = window.innerWidth*.45;
            else
                var centerX = window.innerWidth*.25;
    ...
    DistanceMeter.prototype = {
        ...
        init: function(width) {
            ...
            if(IS_MOBILE)
                this.calcXPos(window.innerWidth*.5);
            else
                this.calcXPos(window.innerWidth*.45);
    ...
    HorizonLine.prototype = {
        ...
        reset: function() {
            this.xPos[0] = 0;
            this.xPos[1] = HorizonLine.dimensions.WIDTH*2;
        }
    };
    //******************************************************************************
    /**
